...
//#region node_modules/.nitro/vite/services/ssr/assets/Contact-sc0-LdM4.js
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MagneticButton, {
								type: "submit",
								children: sending ? "Sending…" : "Schedule a Consultation"
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									href: "mailto:briefings@alphaitms.com",
									className: "group flex items-center gap-3 text-muted-foreground transition-colors hover:text-foreground",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mail, { className: "h-4 w-4 text-[var(--brand-cyan)]" }), "briefings@alphaitms.com"]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									href: "tel:+18005550134",
									className: "group flex items-center gap-3 text-muted-foreground transition-colors hover:text-foreground",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Phone, { className: "h-4 w-4 text-[var(--brand-cyan)]" }), "+1 800 555 0134"]
								})]
							})
						})
					]
