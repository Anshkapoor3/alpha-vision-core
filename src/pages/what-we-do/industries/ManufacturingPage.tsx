...
const capabilities = [
  {
    ...
    description:
      "Our smart manufacturing solutions use IoT, AI, and predictive analytics to build connected factories that optimize production and reduce downtime. From real-time monitoring to predictive maintenance, Alpha IT Managed Services drives efficiency and productivity for manufacturers.",
    features: [
  ...
  },
  {
    ...
    description:
      "Beyond smart manufacturing, our solutions optimize the entire supply chain — from procurement to distribution. With advanced tools for inventory management, demand forecasting, and logistics, Alpha IT Managed Services helps manufacturers streamline operations and cut costs.",
    features: [
  ...
  },
  {
    ...
    description:
      "Quality is key in manufacturing, and Alpha IT Managed Services provides solutions to ensure products meet the highest standards. From automated quality control to real-time defect detection, we help manufacturers deliver consistent, high-quality products.",
    features: [
    ...
    <MainLayout>
      <section id="top" ref={heroRef} className="relative min-h-[70vh] overflow-hidden">
        ...
        >
          ...
          >
            <p>
              Alpha Technologies delivers tailored IT solutions for the manufacturing industry,
              enhancing production efficiency, improving supply chain management, and ensuring
              robust security. Partner with us to leverage cutting-edge technology for operational
              ...
              <div>
                ...
                <Reveal delay={0.12}>
                  <p className="mt-8 text-lg leading-relaxed text-muted-foreground">
                    At Alpha IT Managed Services, our expert support team understands the unique
                    challenges of the manufacturing sector. From implementation to ongoing support,
                    we ensure you maximize the value of our solutions.
                  </p>
                </Reveal>
              </div>
              <Reveal delay={0.1}>
      ...
      <section id="capabilities" className="relative overflow-hidden py-24 lg:py-32">
        <div className="mx-auto w-[min(1400px,92vw)]">
          <SectionHeading
            ...
            title={
              <>
                Three Pillars of <span className="text-gradient">Manufacturing Excellence</span>
              </>
            }
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] border border-border">
              ...
              <div className="relative px-8 py-20 text-center lg:px-20 lg:py-28">
                ...
                <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-muted-foreground">
                  Join the world's leading manufacturers who trust Alpha IT Managed Services to
                  deliver innovative solutions that power success. Get in touch with us today to
                  discover how we can help your organization thrive in the competitive manufacturing
                  landscape.
                </p>
