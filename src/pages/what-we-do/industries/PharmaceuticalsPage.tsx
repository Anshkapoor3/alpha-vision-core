...
const heroImage =
  "https://images.unsplash.com/photo-1576086213369-97a306d36557?q=80&w=2400&auto=format&fit=crop";
...
const capabilities = [
  {
    ...
    description:
      "Our solutions utilize AI and machine learning to analyze large datasets and speed up drug discovery. From target identification to lead optimization, Alpha IT Managed Services helps pharmaceutical companies identify promising drug candidates more efficiently.",
    features: [
  ...
  },
  {
    ...
    description:
      "Beyond drug discovery, our solutions optimize pharmaceutical manufacturing for efficiency, consistency, and quality. With advanced automation and real-time monitoring, Alpha IT Managed Services helps companies streamline operations and accelerate time to market.",
    features: [
      "Advanced automation",
  ...
  },
  {
    ...
    description:
      "Regulatory compliance is crucial in pharma, and Alpha IT Managed Services provides solutions to help navigate complex requirements. From electronic batch records to regulatory reporting, we ensure compliance at every stage of the lifecycle.",
    features: [
...
export function PharmaceuticalsPage() {
      ...
      <section id="top" ref={heroRef} className="relative min-h-[70vh] overflow-hidden">
        ...
        >
          ...
          >
            ...
            <span className="text-foreground">Pharmaceuticals</span>
          </motion.nav>

          <h1 className="display-hero mt-8 max-w-[18ch]">
            {["Pharmaceuticals"].map((line, i) => (
          ...
          >
            <p>
              Alpha IT Managed Services provides specialized IT solutions for pharmaceuticals,
              accelerating drug discovery with AI/ML, optimizing manufacturing, and ensuring
              ...
              <div>
                ...
                <Reveal delay={0.12}>
                  <p className="mt-8 text-lg leading-relaxed text-muted-foreground">
                    At Alpha IT Managed Services, we pride ourselves on our dedicated support team,
                    comprised of industry experts who understand the unique challenges and
                    opportunities facing the pharmaceutical sector. From implementation to ongoing
                    support, we're here to ensure that you get the most out of our solutions.
                  </p>
                </Reveal>
              </div>
              <Reveal delay={0.1}>
      ...
      <section id="capabilities" className="relative overflow-hidden py-24 lg:py-32">
        <div className="mx-auto w-[min(1400px,92vw)]">
          <SectionHeading
            ...
            title={
              <>
                Three Pillars of <span className="text-gradient">Pharmaceutical Excellence</span>
              </>
            }
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] border border-border">
              ...
              <div className="relative px-8 py-20 text-center lg:px-20 lg:py-28">
                ...
                <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-muted-foreground">
                  Join the world's leading pharmaceutical companies who trust Alpha IT Managed
                  Services to deliver innovative solutions that power success. Get in touch with us
                  today to discover how we can help your organization thrive in the competitive
