...
const capabilities = [
  {
    ...
    description:
      "At Alpha IT Managed Services, we're dedicated to delivering top-tier support. Our expert team guides you from implementation through ongoing support and training, so you can focus on innovation and making a meaningful impact.",
    features: [
  ...
  },
  {
    ...
    description:
      "Our advanced analytics platforms equip researchers to analyze and visualize large datasets, uncover insights, and make informed decisions. From discovery to predictive modeling, Alpha IT Managed Services helps unlock the full potential of your data.",
    features: [
  ...
  },
  {
    ...
    description:
      "Alongside advanced analytics, our high-performance computing solutions empower researchers to handle intensive tasks like simulations, complex modeling, and genetic sequencing — accelerating discovery with the power and speed needed for cutting-edge research.",
    features: [
      ...
      <section id="top" ref={heroRef} className="relative min-h-[70vh] overflow-hidden">
        ...
        >
          ...
          <h1 className="display-hero mt-8 max-w-[18ch]">
            {["Research &", "Development"].map((line, i) => (
          ...
          >
            <p>
              Alpha IT Managed Services revolutionizes R&D operations with tailored IT solutions,
              enhancing data analysis, high-performance computing, and accelerating discovery.
            </p>
          </motion.div>
            ...
            <div className="grid gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              <div>
                <SectionHeading
                  ...
                  title={
                    <>
                      Expert <span className="text-gradient">Support</span>
                    </>
                  }
                />
                <Reveal delay={0.12}>
                  <p className="mt-8 text-lg leading-relaxed text-muted-foreground">
                    At Alpha IT Managed Services, we're dedicated to delivering top-tier support.
                    Our expert team guides you from implementation through ongoing support and
                    training, so you can focus on innovation and making a meaningful impact.
                  </p>
                </Reveal>
              </div>
              <Reveal delay={0.1}>
      ...
      <section id="capabilities" className="relative overflow-hidden py-24 lg:py-32">
        <div className="mx-auto w-[min(1400px,92vw)]">
          <SectionHeading
            ...
            title={
              <>
                Three Pillars of <span className="text-gradient">R&D Excellence</span>
              </>
            }
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] border border-border">
              ...
              <div className="relative px-8 py-20 text-center lg:px-20 lg:py-28">
                ...
                <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-muted-foreground">
                  Join the world's leading research institutions who trust Alpha IT Managed Services
                  to deliver innovative solutions that power success. Get in touch with us today to
                  discover how we can help your organization thrive in the competitive research
                  landscape.
                </p>
