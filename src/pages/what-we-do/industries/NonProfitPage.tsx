...
const capabilities = [
  {
    ...
    description:
      "At Alpha IT, we understand the diverse needs of nonprofit agencies — from fundraising and donor management to program delivery and impact measurement. That's why we've developed a range of advanced technology solutions tailored specifically for the nonprofit sector.",
    features: [
  ...
  },
  {
    ...
    description:
      "Our solutions use the latest technologies to help nonprofits engage donors, raise funds, and advance their missions. From online fundraising to donor management, Alpha IT Managed Services equips nonprofits to grow support and increase impact.",
    features: [
  ...
  },
  {
    ...
    description:
      "Beyond fundraising, our solutions streamline program management and impact measurement. From volunteer coordination to outcome tracking, Alpha IT helps nonprofits operate efficiently and showcase their results to stakeholders.",
    features: [
      ...
      <section id="top" ref={heroRef} className="relative min-h-[70vh] overflow-hidden">
        ...
        >
          ...
          >
            ...
            <span className="text-foreground">Non-Profit Agencies</span>
          </motion.nav>

          <h1 className="display-hero mt-8 max-w-[18ch]">
            {["Non-Profit", "Agencies"].map((line, i) => (
          ...
          >
            <p>
              Alpha IT Managed Services provides tailored solutions for nonprofits, boosting
              efficiency, strengthening security, and advancing your mission. Partner with us to
              harness advanced technology and maximize your impact.
            </p>
          </motion.div>
            ...
            <div className="grid gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              <div>
                <SectionHeading
                  ...
                  title={
                    <>
                      Data Management <span className="text-gradient">and Compliance</span>
                    </>
                  }
                />
                <Reveal delay={0.12}>
                  <p className="mt-8 text-lg leading-relaxed text-muted-foreground">
                    Data management and compliance are critical for nonprofit agencies, and Alpha
                    Technologies offers solutions to help organizations manage their data securely
                    and ensure compliance with regulations. From data privacy to financial
                    transparency, our solutions help nonprofit agencies build trust with
                    stakeholders and operate with integrity.
                  </p>
                </Reveal>
              </div>
              <Reveal delay={0.1}>
      ...
      <section id="capabilities" className="relative overflow-hidden py-24 lg:py-32">
        <div className="mx-auto w-[min(1400px,92vw)]">
          <SectionHeading
            ...
            title={
              <>
                Three Pillars of <span className="text-gradient">Non-Profit Impact</span>
              </>
            }
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] border border-border">
              ...
              <div className="relative px-8 py-20 text-center lg:px-20 lg:py-28">
                ...
                <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-muted-foreground">
                  Join the world's leading non-profits who trust Alpha IT Managed Services to
                  deliver innovative solutions that power success. Get in touch with us today to
                  discover how we can help your organization thrive and maximize your impact.
                </p>
