...
const capabilities = [
  {
    ...
    description:
      "Our solutions use AI and machine learning to optimize network performance and ensure seamless connectivity. From optimization to predictive maintenance, Alpha IT Managed Services helps telecom companies provide reliable, high-performance services.",
    features: [
  ...
  },
  {
    ...
    description:
      "Beyond network performance, our solutions drive digital transformation in telecoms. From digital customer engagement to agile operations, Alpha IT Managed Services helps companies adapt to market changes and stay competitive.",
    features: [
  ...
  },
  {
    ...
    description:
      "Innovation drives telecom, and Alpha IT Managed Services offers solutions to keep companies at the forefront. From IoT to edge computing, our services help telecoms explore new opportunities and create value for customers.",
    features: [
      "IoT integration",
      "Edge computing",
      "New revenue streams",
    ...
    <MainLayout>
      <section id="top" ref={heroRef} className="relative min-h-[70vh] overflow-hidden">
        ...
        >
          ...
          >
            <p>
              Alpha IT delivers innovative solutions for the telecommunications industry, enhancing
              network performance, improving security, and driving operational efficiency. Partner
              with us to leverage cutting-edge technology for superior connectivity and service
              excellence.
            </p>
          </motion.div>
            ...
            <div className="grid gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              <div>
                <SectionHeading
                  ...
                  title={
                    <>
                      Customized <span className="text-gradient">Solutions</span>
                    </>
                  }
                />
                <Reveal delay={0.12}>
                  <p className="mt-8 text-lg leading-relaxed text-muted-foreground">
                    At Alpha Technologies, we understand that every telecommunications company is
                    unique. That's why we offer customized solutions tailored to your specific needs
                    and objectives. Whether you're looking to optimize your network, enhance
                    customer experiences, or explore new revenue streams, we'll work closely with
                    you to develop the right solution for your business.
                  </p>
                </Reveal>
              </div>
              <Reveal delay={0.1}>
      ...
      <section id="capabilities" className="relative overflow-hidden py-24 lg:py-32">
        <div className="mx-auto w-[min(1400px,92vw)]">
          <SectionHeading
            ...
            title={
              <>
                Three Pillars of <span className="text-gradient">Telecom Excellence</span>
              </>
            }
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] border border-border">
              ...
              <div className="relative px-8 py-20 text-center lg:px-20 lg:py-28">
                ...
                <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-muted-foreground">
                  Join the world's leading telecom companies who trust Alpha IT Managed Services to
                  deliver innovative solutions that power success. Get in touch with us today to
                  discover how we can help your organization thrive in the competitive
