...
const capabilities = [
  {
    ...
    description:
      "At Alpha IT Managed Services, we recognize the challenges financial institutions face — from strict regulatory demands to shifting customer expectations. That's why we offer a comprehensive suite of solutions designed to help financial institutions succeed in the digital era.",
    features: [
  ...
  },
  {
    ...
    description:
      "Our cutting-edge IT solutions strengthen security, optimize operations, and support regulatory compliance, enabling financial institutions to concentrate on what matters most — serving clients and expanding their business.",
    features: [
    ...
    <MainLayout>
      <section id="top" ref={heroRef} className="relative min-h-[70vh] overflow-hidden">
        ...
        >
          ...
          >
            <p>
              Alpha IT Managed Services delivers tailored IT solutions for the financial services
              industry, boosting security, optimizing operations, and driving innovation.
              Collaborate with us to harness cutting-edge technology and elevate your financial
              ...
              <div>
                ...
                <Reveal delay={0.12}>
                  <p className="mt-8 text-lg leading-relaxed text-muted-foreground">
                    Our dedicated support team — made up of industry experts — is committed to
                    understanding and addressing the unique challenges and opportunities within the
                    financial services sector. From initial implementation to continuous support,
                    we're here to help you maximize the value of our solutions.
                  </p>
                </Reveal>
              </div>
              <Reveal delay={0.1}>
      ...
      <section id="capabilities" className="relative overflow-hidden py-24 lg:py-32">
        <div className="mx-auto w-[min(1400px,92vw)]">
          <SectionHeading
            ...
            title={
              <>
                Three Pillars of <span className="text-gradient">Financial Excellence</span>
              </>
            }
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] border border-border">
              ...
              <div className="relative px-8 py-20 text-center lg:px-20 lg:py-28">
                ...
                <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-muted-foreground">
                  Join the world's leading financial institutions who trust Alpha IT Managed
