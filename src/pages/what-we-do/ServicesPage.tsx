...
const services = [
  {
    ...
    description:
      "End-to-end managed services covering infrastructure, applications, databases, and end-user computing. Proactive monitoring, incident management, problem management, change management, and continuous service improvement — all backed by financially-backed SLAs.",
    longDescription:
    ...
    compliance: ["ISO 27001", "SOC 2 Type II", "ITIL 4", "PCI-DSS", "HIPAA", "GDPR"],
    stats: [
      { value: 99.9, suffix: "%", decimals: 1, label: "Service Availability" },
      { value: 5, suffix: " min", label: "Critical Response" },
      { value: 50, suffix: "K+", label: "Endpoints Managed" },
      { value: 15, suffix: "+", label: "Years Avg. Tenure" },
    ],
    outcomes: [
  ...
  },
  {
    ...
    description:
      "Comprehensive cybersecurity services: managed detection & response (MDR), vulnerability management, penetration testing, identity & access management, GRC automation, and incident response. Threat intelligence-driven with MITRE ATT&CK alignment.",
    longDescription:
    ...
    compliance: ["NIST CSF", "ISO 27001", "SOC 2", "PCI-DSS", "HIPAA", "FedRAMP", "CMMC 2.0"],
    stats: [
      { value: 10, suffix: "B+", label: "Events/Day Monitored" },
      { value: 1, suffix: " hr", label: "IR Mobilization" },
      { value: 99, suffix: "%", label: "Threat Detection Rate" },
      { value: 50, suffix: "+", label: "Certified Analysts" },
    ],
    outcomes: [
  ...
  },
  {
    ...
    description:
      "Full-lifecycle cloud services: strategy & assessment, migration factory, landing zones, DevOps platform engineering, FinOps, and managed cloud operations. Multi-cloud expertise across AWS, Azure, GCP, and VMware Cloud.",
    longDescription:
    ...
    compliance: ["AWS Well-Architected", "Azure CAF", "SOC 2", "ISO 27001", "FedRAMP", "HIPAA", "PCI-DSS"],
    stats: [
      { value: 500, suffix: "+", label: "Apps Migrated" },
      { value: 50, suffix: " PB", label: "Data Migrated" },
      { value: 35, suffix: "%", label: "Avg. Cost Savings" },
      { value: 99.5, suffix: "%", decimals: 1, label: "Migration Success" },
    ],
    outcomes: [
  ...
  },
  {
    ...
    description:
      "Enterprise digital transformation: strategy & roadmap, customer experience design, process automation, legacy modernization, data platform implementation, and organizational change management. Outcome-based with measurable KPIs.",
    longDescription:
    ...
    compliance: ["TOGAF", "SAFe", "ITIL 4", "CMMI", "ISO 9001", "GDPR", "CCPA"],
    stats: [
      { value: 40, suffix: "%", label: "Process Efficiency Gain" },
      { value: 60, suffix: "%", label: "Faster Time-to-Market" },
      { value: 3, suffix: "x", label: "Digital Revenue Growth" },
      { value: 90, suffix: "%", label: "User Adoption Rate" },
    ],
    outcomes: [
  ...
  },
  {
    ...
    description:
      "IT strategy, enterprise architecture, application portfolio rationalization, technology radar, vendor management, and IT financial management. Delivered by former CIOs and principal architects with Fortune 500 experience.",
    longDescription:
    ...
    compliance: ["TOGAF", "ITIL 4", "COBIT", "TBM", "ISO 38500", "NIST CSF"],
    stats: [
      { value: 30, suffix: "%", label: "IT Cost Reduction" },
      { value: 50, suffix: "+", label: "Apps Rationalized" },
      { value: 100, suffix: "%", label: "Stakeholder Alignment" },
      { value: 5, suffix: "M+", label: "Annual Savings Identified" },
    ],
    outcomes: [
  ...
  },
  {
    ...
    description:
      "Large-scale implementation and integration: ERP (SAP, Oracle, Workday), CRM (Salesforce, Dynamics), HCM, ITSM (ServiceNow), middleware (MuleSoft, Boomi, Azure Integration), API management, and data migration. PMI-certified delivery with rigorous governance.",
    longDescription:
    ...
    compliance: ["PMI/PMP", "ITIL 4", "CMMI", "ISO 9001", "SOX", "GDPR", "HIPAA"],
    stats: [
      { value: 200, suffix: "+", label: "Implementations" },
      { value: 95, suffix: "%", label: "On-Time Delivery" },
      { value: 50, suffix: "+", label: "Certified Consultants" },
      { value: 98, suffix: "%", label: "UAT First-Pass Rate" },
    ],
    outcomes: [
  ...
  },
  {
    ...
    description:
      "Specialized practices: mainframe modernization, Oracle licensing optimization, SAP license management, IT audit & assessment, disaster recovery as a service (DRaaS), high-performance computing (HPC), and executive advisory. Deep specialist teams, not generalists.",
    longDescription:
    ...
    compliance: ["NIST", "ISO 27001", "SOX", "PCI-DSS", "HIPAA", "FedRAMP", "GDPR"],
    stats: [
      { value: 60, suffix: "%", label: "MIPS Reduction" },
      { value: 40, suffix: "%", label: "License Savings" },
      { value: 15, suffix: " min", label: "DRaaS RPO" },
  ...
  },
  {
    ...
    description:
      "End-to-end data services: modern data architecture (lakehouse, mesh, fabric), data engineering & pipelines, master data management, data governance & catalog, business intelligence, advanced analytics, and MLOps. Cloud-agnostic with open standards.",
    longDescription:
    ...
    compliance: ["GDPR", "CCPA", "HIPAA", "SOX", "PCI-DSS", "FedRAMP", "ISO 27001"],
    stats: [
      { value: 100, suffix: "TB+", label: "Data Under Management" },
      { value: 500, suffix: "+", label: "Pipelines in Production" },
      { value: 90, suffix: "%", label: "Data Quality Score" },
      { value: 10, suffix: "x", label: "Faster Insight Delivery" },
    ],
    outcomes: [
  ...
  },
  {
    ...
    description:
      "Full-lifecycle custom development: product discovery & strategy, UX/UI design, cloud-native development (React, .NET, Java, Go, Node, Python), mobile (iOS, Android, Flutter, React Native), QA automation, DevSecOps, and product support. Agile, outcome-focused, IP-retaining.",
    longDescription:
    ...
    compliance: ["OWASP", "NIST SSDF", "ISO 27001", "SOC 2", "GDPR", "HIPAA", "FDA 21 CFR Part 11"],
    stats: [
      { value: 150, suffix: "+", label: "Products Delivered" },
      { value: 95, suffix: "%", label: "On-Time Sprint Delivery" },
      { value: 4.8, suffix: "/5", decimals: 1, label: "Client NPS" },
      { value: 40, suffix: "%", label: "Faster Than In-House" },
    ],
    outcomes: [
      ...
      <section id="top" className="relative min-h-[70vh] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto w-[min(1400px,92vw)] pt-32 pb-16 lg:pt-40">
          ...
          <h1 className="display-hero mt-8 max-w-[18ch]">
            {["Services that", "deliver", "outcomes."].map((line, i) => (
          ...
          >
            <p>
              Nine service lines. One delivery standard. From 24/7 managed operations to custom product development,
              every engagement is backed by certified experts, proven methodologies, and financially-backed SLAs.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section id="services" className="relative overflow-hidden py-24 lg:py-32">
        <div className="mx-auto w-[min(1400px,92vw)]">
          <SectionHeading
            ...
            title={
              <>
                Nine services, <span className="text-gradient">one standard</span>
              </>
            }
              ...
              <Reveal key={svc.name} delay={i * 0.06}>
                ...
                >
                  ...
                  <div className="relative flex flex-col h-full">
                    ...
                    <h3 className="mt-7 text-xl font-medium">{svc.name}</h3>
                    <p className="mt-3 text-sm leading-relaxed text-muted-foreground flex-1">{svc.tagline}</p>
        ...
        <div className="relative mx-auto w-[min(1400px,92vw)]">
          <div className="space-y-28">
            {services.map((svc, idx) => (
              <Reveal key={svc.name} delay={idx % 2 === 0 ? 0 : 0.1}>
                <div className="grid gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                  {idx % 2 === 0 ? (
                    <>
                      ...
                      <div>
                        <SectionHeading index={`0${idx + 2}`} eyebrow="Service" title={<>{svc.name}</>} />
                        <p className="mt-4 text-lg leading-relaxed text-[var(--brand-cyan)] font-medium">{svc.tagline}</p>
                        <p className="mt-6 text-lg leading-relaxed text-muted-foreground">{svc.description}</p>
                        <p className="mt-6 text-base leading-relaxed text-muted-foreground">{svc.longDescription}</p>
                        ...
                        <div className="mt-10">
                          <h4 className="text-sm font-medium uppercase tracking-[0.14em] text-muted-foreground">Compliance & frameworks</h4>
          ...
          <Reveal>
            <div className="relative overflow-hidden rounded-[2.5rem] border border-border">
              ...
              <div className="relative px-8 py-20 text-center lg:px-20 lg:py-28">
                <p className="eyebrow">Engage our experts</p>
                <h2 className="display-section mt-6">
                  Start Your <span className="text-gradient">Next Initiative</span>
                </h2>
                <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-muted-foreground">
                  From advisory to managed operations, our teams are ready to deploy. Tell us about your challenge
                  and we'll connect you with the right practice lead.
                </p>
